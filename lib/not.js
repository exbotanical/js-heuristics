...
/**
 * @summary Evaluate whether the given object, array, or string is wholly empty
...
/**
 * @summary Object's values are not null, NaN, or undefined, no matter how nested
 * @param {(object|any)} o 
 * @returns {boolean}
 */
...
/**
 * @summary Explicitly determine if given value is null or undefined
 * @param {any} _
 * @returns {boolean}
 */
...
/**
 * @summary Determine if a property exists in an object or its prototype chain
